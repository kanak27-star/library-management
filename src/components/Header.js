...
const Header = ({ onAddBookClick, onAddBorrowerClick, onAddAuthorClick, onUpdateBookClick, onUpdateBorrowerClick, onDeleteBookClick, onDeleteBorrowerClick, onUpdateAuthorClick, onCheckinClick, onCheckoutClick, onChartsClick, goHome }) => {
    ...
    <div className="bg-gradient-to-r from-slate-900 to-blue-900 p-4 rounded-t-lg">
      ...
      <h1 onClick={goHome} className="flex items-center text-blue-300 text-2xl lg:text-3xl xl:text-4xl font-bold tracking-wide ml-auto justify-start hover:cursor-pointer focus:cursor-alias ">
        ...
        <div className="flex space-x-2 ml-auto justify-end">
          ...
          <button onClick={onChartsClick} className="bg-green-600 text-white px-4 mb-2 rounded font-semibold hover:bg-green-500 focus:ring-4 focus:ring-green-400">
            <FontAwesomeIcon icon={faBook} className="mr-2" />Statistics
          </button>
        </div>
      </div>
    </div>
